            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <form class="row contact_form" action="actions/action_upstock.php" method="post" id="contactForm" novalidate="novalidate">
                            ...
                            <div class="col-md-4">
                                <p>Producto</p>
                                <select name="producto" id="prod_d" class="form-control" style="display: initial;">
                                </select>
                            </div>
                            <div class="col-md-2">
                                <p>Cantidad actual</p>
                                <input type="text" class="form-control" id="act" name="" placeholder="0" disabled>
                            </div>
                            <div class="col-md-2">
                                <p>Cantidad a agregar</p>
                                <input type="text" class="form-control" id="cantidad" name="cantidad" placeholder="0">
                            </div>

                            <div class="col-md-12 text-right">
                                <button type="submit" value="submit" class="btn submit_btn">ACTUALIZAR PRODUCTO</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-3  col-md-6 col-sm-6">
                        <div class="single-footer-widget">
                            ...
                            <p>El mundo se ha convertido tan actualizado en las personas ya que no quieren tener una vida fuera de la red de Internet, prefieren mantenerse conectadas por medio de aplicaciones, páginas web o bien entender mensajes por medio de imágenes. Ha llegado al punto de convertirse en la herramienta principal y por eso Cachirulo's te ofrece las mejores ofertas a los mejores precios.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-footer-widget">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('#compra').click(function () {
                    ...
                    console.log("ID: " + id + " Cant: " + cant + " Precio(c/u): " + precio + " Total: " + tot);
