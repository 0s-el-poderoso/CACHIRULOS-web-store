<?php
    ...
    if (isset($_SESSION['prv'])){ header('Location: provider.php'); }
    else if (!isset($_SESSION['adm'])){ header('Location: index.php'); }
?>
    ...
    <body>
        ...
        <section class="contact_area p_120">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <form class="row contact_form" action="actions/action_dropuser.php" method="post" id="contactForm" novalidate="novalidate">
                            <div class="col-md-4"></div>
                            <div class="col-md-4 text-center">
                                <p>RFC:</p>
                                <input type="text" class="form-control ui-autocomplete" id="rfc" name="rfc" placeholder="RFC Ciente">
                            </div>
                            <div class="col-md-4"></div>
                            <div class="col-md-12 text-center">
                                <button type="submit" value="submit" class="btn submit_btn">Eliminar</button>
                            </div>
                        </form>
                    </div>
                </div>
