            ...
            <div class="main_menu">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="container box_1620">
                        ...
                        <a class="navbar-brand logo_h" href="index.php"><p style="text-align: center;
            font-family: Impact;
            color: black;
            font-size: 30px;">CACHIRULO'S</p></a>
							...
							<ul class="nav navbar-nav menu_nav ml-auto">
								...
								<li class="nav-item submenu dropdown active">
									...
									<ul class="dropdown-menu">
										<li class="nav-item"><a class="nav-link" href="portfolio.php">ALTAS</a>
										<li class="nav-item"><a class="nav-link" href="portfolio-details.php">BAJAS</a>
									</ul>
								</li>
                                <li class="nav-item submenu dropdown active">
                                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Proveedor</a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a class="nav-link" href="portfolio.php">ALTAS</a>
                                        <li class="nav-item"><a class="nav-link" href="portfolio-details.php">BAJAS</a>
                                    </ul>
