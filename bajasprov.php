            ...
            <table class="table table-hover">
                ...
                <tbody id="tbl_contenido">
                    ...
                    while($row = mysqli_fetch_assoc($result)){ ?>
                        ...
                        <tr>
                            <td class="text-center"><?php echo $row['id_prov']; ?></td>
                            <td class="text-center"><?php echo $row['empresa']; ?></td>
                            <td class="text-center"><?php echo $row['rfc']; ?></td>
                            <td class="text-center">
                                <button class="btn btn-danger btn-sm btnEliminar" data-id="<?php echo $row['id_prov']; ?>"
                                data-prov="<?php echo $row['empresa']; ?>" data-rfc="<?php echo $row['rfc']; ?>">Eliminar</button>
                            </td>				
                        </tr>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('.btnEliminar').click(function () {
                    ...
                    if(confirm("Desea eliminar el proveedor '" + prov + "'?")){

                        $.ajax({
                            type: "POST",
                            url: "actions/action_dropprov.php",
                            data: {'rfc': rfc}
                        })
                        .done(function(data){
                            if(data != null){
