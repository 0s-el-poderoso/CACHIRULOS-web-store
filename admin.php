...
<html lang="en">
    <head>
        ...
        <style>
            #foot{
                background-color: rgba(230, 255, 218, 0.733);
            }

            #head{
                background-color: rgba(218, 255, 255, 0.733);
            }
        </style>
    </head>
    <body>
                    ...
                    <div class="container box_1620">
						...
						<div class="collapse navbar-collapse offset nav-options" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
								...
								<li class="nav-item submenu dropdown active">
									<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Acciones</a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a class="nav-link" href="bajas_usuarios.php">Bajas Usuarios</a>
                                        <li class="nav-item"><a class="nav-link" href="altasprov.php">Altas Proveedores</a>
        ...
        <section class="text_members_area p_120">
        	<div class="container">
                <div class="banner_content text-center">
                    ...
                    <center><input style="width: 9rem;" class="form-control" type="text" id="sum" value="$0" disabled="disabled"></center><br><br>
                </div>
